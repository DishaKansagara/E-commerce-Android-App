...
public class CartItemModel
{
    ...
    private String seletedCoupenId;
    ...
    public String getSeletedCoupenId() {
        return seletedCoupenId;
    }

    public void setSeletedCoupenId(String seletedCoupenId) {
        this.seletedCoupenId = seletedCoupenId;
    }
